                  ...
                  <form id="register-form"  role="form" style="display: block;">
                    ...
                    <div class="row">
                      <div class="form-group col-md-6">
                        <input type="text" name="lname" id="lname" tabindex="12" class="form-control register" placeholder="نام خانوادگی" value="">
                      </div>
                      <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                      <input type="text" name="phone" id="phone" tabindex="14" class="form-control register" placeholder="تلفن همراه" value="">
                    </div>
                    <div class="form-group">
