                ...
                <div class="col-lg-12">
                  <form id="register-form"  role="form" style="display: block;">
                    <div class="form-group">
                      <label>ایمیلی که با آن ثبت نام کرده اید را جهت بازیابی گذرواژه وارد کنید</label>
                    </div>
                    <div class="form-group">
                      <input type="email" name="email" id="email" tabindex="10" class="form-control register" placeholder="آدرس ایمیل" value="">
                    </div>
                    <div class="form-group">
                          <input type="button" name="register-submit" id="register-submit" tabindex="17" class="form-control btn btn-primary  btn-fill" value="ارسال ایمیل" onclick="forget()">
                    </div>
                    <div class="form-group">
...
function forget() {
   var values = {
    ...
    $.ajax({
        url: '<?php echo base_url();  ?>signup/forget_password',
            type: 'POST',
            dataType: 'json',
